...
import { formatDate, scaleSentiment } from '../../utils/CommonFunctions';
import PondrLineChart from './PondrLineChart';
import { FaQuestionCircle, FaRegThumbsDown, FaRegThumbsUp, FaSmile } from 'react-icons/fa';
...
const CategoriesReviews = (props) => {
  ...
  const { productId, companyProducts, demo } = props;
      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6'>
        ...
        <div className='flex justify-between w-full mt-10'>
          <div className='w-full'>
            ...
            <span
              className='bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-purple-400  h3'
            >
